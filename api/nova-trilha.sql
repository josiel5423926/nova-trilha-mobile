...
--
-- Host: localhost:3306
-- Tempo de geração: 08/03/2021 às 22:40
...
(1, 'Recepcionista', 'Área e especialização profissional: Administração - Recepção', 'Animalias Pet Center', 'São Paulo - SP', '1.500,00', 'logo_pet.png', NULL, NULL, NULL, '2021-02-26 11:55:11'),
(6, 'Controladora de Acesso', 'Será responsável pela fiscalização e guarda do patrimônio, além de controlar a entrada e saída de pessoas e veículos nas dependências da empresa, bem como orientar as pessoas sobre seus destinos.', 'Menezes Advogados', 'São Paulo - SP', '2.000,00', 'logo_advocacia.png', NULL, NULL, NULL, '2021-02-26 11:55:11'),
(9, 'Secretária', 'Auxiliar no atendimento aos clientes, preencher documentos e tabelar dados de cadastro ', 'Menezes Advogados', 'São Paulo - SP', '1.600,00', 'logo_advocacia.png', NULL, NULL, NULL, '2021-02-26 11:55:11');
